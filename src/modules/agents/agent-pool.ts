...
// All agents use fast-api (x-or.cloud) — reliable, fast, cheap
// Claude SDK/CLI removed to avoid dependency issues
...
export function initAgentPool(config: PoolConfig): {
  ...
  // Commander uses fast-api (same as workers, reliable)
